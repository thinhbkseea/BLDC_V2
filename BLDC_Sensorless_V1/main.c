...
//            SensorlessTrapController.CurrentDutyCycle = 10;
    ...
    case MOTOR_IPD:
        ...
        if(SensorlessTrapController.IPDStatus == DONE)
        {
            ...
            DRV8x_Digital_Init();                                                          /*Initialize MSP430F5529 peripherals */
//            if (SensorlessTrapController.DeviceID & BIT1)                                  // Reset current setting after IPD
//            {
...
//                drv832x_regRestoreFromCache();                      // Default values are read by GUI after enabling the pre drivers
//            }
//        }
//    }
//
