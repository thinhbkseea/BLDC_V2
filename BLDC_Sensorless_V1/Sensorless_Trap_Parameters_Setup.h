...
#define ALIGN_WAIT_TIME             150     // Number of PWM cycles to Wait during align align time seconds = [this number * 41us]
...
#define START_UP_DUTY_CYCLE         200//330         // relative to PWM_PERIOD
...
#define MOTOR_PHASE_CURRENT_LIMIT (744) //(900) Vso = 1.65-Imax*Gcsa*Rsense = 1.65-30*10*0.002 = 1.05V (1300)744
...
#define START_CURRENT_LIMIT (700)
