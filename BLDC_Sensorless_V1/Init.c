...
void Init_Application()
{
    ...
    SensorlessTrapController.StartCurrentLimit = START_CURRENT_LIMIT;
...
//    SensorlessTrapController.DeviceID = ((SensorlessTrapController.DeviceID<<1) + ((0 & BIT2)>>2));
    SensorlessTrapController.DeviceID = 0x06;   //BIT0 - SPI variant, BIT1 - sensorless, BIT2 - DRV8323x
...
//IPD Variables
    ...
    SensorlessTrapController.StartOpenLoop = 0;
...
{
    if(SensorlessTrapController.DeviceID & BIT1)    //sensorless
    {
//        ADCCTL0 = 0x00;
//        ADCCTL0 = ADCON | ADCSHT_2;                            // Turn on ADC, avoid overflow of results , select 16 clock cycles for sampling current , 4 clk cycles for sampling BEMF
        ...
        ADCMCTL0 = ADCINCH_6;                           //   channel = A3 (Read the CSA reading from Phase C )
...
/* LED initialization ports P1.0 and P4.7 */
    ...
    P4DIR |= BIT5 | BIT6 | BIT7;    //LED 0, 1, 2
...
/* ADC Input Channels Selected as ADC function eliminates parasitic currents flow */
    P1SEL0 |= BIT0 | BIT1| BIT2 | BIT3 | BIT4 | BIT5 | BIT6;
    P1SEL1 |= BIT0 | BIT1| BIT2 | BIT3 | BIT4 | BIT5 | BIT6;
    P5SEL0 |= BIT0;
    P5SEL1 |= BIT0;
...
//
//    Driver_Control_Reg.REG2_RSVD = (regValue & RSVD_MASK) >> 10;
...
//{
//    // Set Register 0x02
//    Driver_Control_Reg.REG2_RSVD = RSVD;
...
//
//    // Set Register 0x03
//    Gate_Drive_HS_Reg.REG3_LOCK = LOCK;
...
//
//    // Write Register 0x02
//    regValue = (Driver_Control_Reg.REG2_RSVD << 10) |
...
//        if (SensorlessTrapController.DeviceID & BIT1)
//        {
